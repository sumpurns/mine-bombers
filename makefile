...
SERVER_SOURCES=src/xml.cpp src/helpers.cpp src/terrain.cpp src/terrain_defs.cpp src/socket.cpp src/server_main.cpp src/texture.cpp  src/textures_reg.cpp
